...
export const getAllRestaurantsAction = (token) => {
    return async (dispatch) => {
        ...
        try {
            ...
            console.log("all restaurants error", error);
        }
    };
};
...
export const deleteRestaurant = ({restaurantId, jwt}) => {
    return async (dispatch) => {
        ...
        try {
            ...
            dispatch({type:DELETE_RESTAURANT_SUCCESS, payload:res})
...
export const updateRestaurantStatus = ({restaurantId, jwt}) => {
    return async (dispatch) => {
        ...
        try {
            ...
            console.log("update restaurant status ", res)
        } catch (error) {
...
export const getAllEvents = ({jwt}) => {
    return async (dispatch) => {
        ...
        try {
            ...
            console.log("get all events ", res)
        } catch (error) {
...
export const getRestaurantsEvents = ({restaurantId, jwt}) => {
    return async (dispatch) => {
        ...
        try {
            ...
            console.log("get restaurant events ", res)
        } catch (error) {
