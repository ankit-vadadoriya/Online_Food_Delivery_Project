...
import { createMenu } from "../../component/State/Menu/Action";
...
const CreateMenuForm = () => {
  ...
  const formik = useFormik({
    ...
    onSubmit: (values) => {
      ...
      console.log("create menu data ----", values);
    },
  });
          ...
          <Grid container spacing={2}>
            <Grid className="flex flex-wrap gap-5" item xs={12}>
              ...
              <label className="relative" htmlFor="fileInput">
                ...
                {uploadImage && (
                  <div className="absolute left-0 top-0 right-0 bottom-0 w-24 h-24 flex justify-center items-center">
                    <CircularProgress />
                  </div>
                )}
              </label>
