              ...
              {menu.menuItems.map((item) => (
                ...
                >
                  ...
                  >
                    ...
                    <Button onClick={()=>handleUpdateAvailability(item.id)} 
                            sx={{ color: item.available ? "green" : "red", fontWeight: "bold" }}>
                              {item.available ? "in_stoke" : "out_of_stoke"}
                              </Button>
                  </TableCell>
                  <TableCell align="right">
